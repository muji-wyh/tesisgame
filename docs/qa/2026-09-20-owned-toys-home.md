...
The final targeted native runs passed **1,638 assertions** across playroom view
(292), direct play (98), card polish (250), collection navigation (79), gift
...
Final browser regression: **21 passed**, zero failures, across desktop Chromium
