...
Choose **Match**, **Sky words**, or **Listen** above the board. Match keeps the eight-card,
...
Replay keeps the mode and chosen world. The word shelf lets players hear every word they found.
...
Open **My rewards** to visit **Pip's playroom**: choose Dance, Snack, or Bubbles.
Open an earned medal and choose **Display with Pip** to save it as the playroom's favorite.
The favorite is saved immediately in browser storage, or in `user://playroom.cfg` in native builds.
...
belong to its topic. Play again chooses a different available adventure and fresh words.
...
**Words you found** shows the pairs you matched, even if the round ended with mistakes.
