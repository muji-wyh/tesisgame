...
After 12–16 seconds of inactivity in normal play or Pip's room, Pip may wave,
offer a high five, play peekaboo, look around, stretch, preen or hop. Each
invitation lasts under two seconds and is followed by another full quiet
interval. Input, held pointers, Peek, speech and answer feedback take priority.
...
plum, ice blue with violet, teal with coral, and space violet with gold. Room
walls and toy-card illustration backgrounds add color without reducing text
contrast. The original word and reward artwork remains unchanged.
